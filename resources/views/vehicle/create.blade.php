                ...
                <form method="post" action="{{ route('Vehicle.Store') }}" class="mt-2">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="type" class="control-label">Tipe Kendaraan</label>@error('type')<span class="text-danger">{{ $message }}</span>@enderror
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="police_number" class="control-label">Plat Nomor</label> @error('police_number')<span class="text-danger">{{ $message }}</span>@enderror
                            <input type="text" name="police_number" class="form-control" />
                            <div id="police_numberHelp" class="form-text">Contoh: B 1234 ABC</div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="color" class="control-label">Warna</label> @error('color')<span class="text-danger">{{ $message }}</span>@enderror 
                            <input type="text" name="color" class="form-control" />
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="year" class="control-label">Tahun Pembuatan</label>@error('year')<span class="text-danger">{{ $message }}</span>@enderror
                            <input type="text" name="year" class="form-control" />
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="vehicle_owner" class="control-label">Nama Pemilik</label> @error('vehicle_owner')<span class="text-danger">{{ $message }}</span>@enderror 
                            <input type="text" name="vehicle_owner" class="form-control" />
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="chassis_number" class="control-label">No. Rangka</label> @error('chassis_number')<span class="text-danger">{{ $message }}</span>@enderror 
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <label for="machine_number" class="control-label">No. Mesin</label>@error('machine_number')<span class="text-danger">{{ $message }}</span>@enderror   
