...
class VehicleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'type.regex' => ' harus mengandung huruf, angka, dan spasi saja.',
            'classify.required' => ' wajib diisi.',
            'classify.regex' => ' harus mengandung huruf dan angka saja.',
            'police_number.required' => ' wajib diisi.',
            'police_number.regex' => ' harus mengandung huruf dan angka saja.',
            'police_number.unique' => ' sudah digunakan.',
            'color.required' => ' wajib diisi.',
            'color.regex' => ' harus mengandung huruf dan spasi saja.',
            'year.required' => ' wajib diisi.',
            'year.numeric' => ' harus mengandung angka saja.',
            'vehicle_owner.required' => ' Kendaraan wajib diisi.',
            'vehicle_owner.regex' => ' Kendaraan harus mengandung huruf dan spasi saja.',
            'chassis_number.required' => ' wajib diisi.',
            'chassis_number.regex' => ' harus mengandung huruf dan angka saja.',
            'machine_number.required' => ' wajib diisi.',
            'machine_number.regex' => ' harus mengandung huruf dan angka saja.',
        ]);        
